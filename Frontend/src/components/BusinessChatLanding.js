...
//   return (
//     <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white min-h-screen relative overflow-x-hidden">
//       {/* Animated Background */}
...
//               <a href="#businesses" className="hover:text-blue-400 transition-colors">Businesses</a>
